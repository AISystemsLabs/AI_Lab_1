export const texts = [
	{
		id: 'novice',
		header: 'Новачок (Novice)',
		ukrHeader: 'Новачок',
		points: [[5, 3, 2], [2, 3, 5], [5, 3, 2], [5, 3, 2]],
		description:
	...
	{
		id: 'beginner',
		ukrHeader: 'Початківець',
		header: 'Твердий початківець (Advanced beginner)',
		points: [[5, 3, 2], [2, 3, 5], [2, 3, 5]],
		description:
	...
	{
		id: 'competent',
		ukrHeader: 'Компетентний',
		points: [[5, 3, 2], [5, 3, 2], [2, 3, 5]],
		header: 'Компетентний (Competent)',
		description:
	...
	{
		id: 'proficient',
		ukrHeader: 'Досвідчений',
		points: [[5, 3, 2], [5, 3, 2], [5, 3, 2]],
		header: 'Досвідчений (Proficient)',
		description:
